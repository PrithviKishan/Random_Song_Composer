import lyricsgenius   #using genius for getting lyrics

# generate an api key and paste it
# https://genius.com/api-clients
genius = lyricsgenius.Genius("ENTER-YOUR-ACCESS-TOKEN-HERE")

#note 'Genius.com' has some connection issue for indian ISPs and connection often timesout.
